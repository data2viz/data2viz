...
![Build Status](https://img.shields.io/badge/version-0.8.19-blueviolet)
...
kotlin {
    sourceSets {
        commonMain {
             dependencies {
                 implementation("io.data2viz.d2v:axis:0.8.19")
                 implementation("io.data2viz.d2v:chord:0.8.19")
                 implementation("io.data2viz.d2v:color:0.8.19")
                 implementation("io.data2viz.d2v:contour:0.8.19")
                 implementation("io.data2viz.d2v:delaunay:0.8.19")
                 implementation("io.data2viz.d2v:dsv:0.8.19")
                 implementation("io.data2viz.d2v:ease:0.8.19")
                 implementation("io.data2viz.d2v:force:0.8.19")
                 implementation("io.data2viz.d2v:format:0.8.19")
                 implementation("io.data2viz.d2v:geo:0.8.19")
                 implementation("io.data2viz.d2v:hexbin:0.8.19")
                 implementation("io.data2viz.d2v:hierarchy:0.8.19")
                 implementation("io.data2viz.d2v:quadtree:0.8.19")
                 implementation("io.data2viz.d2v:random:0.8.19")
                 implementation("io.data2viz.d2v:scale:0.8.19")
                 implementation("io.data2viz.d2v:shape:0.8.19")
                 implementation("io.data2viz.d2v:tile:0.8.19")
                 implementation("io.data2viz.d2v:time:0.8.19")
                 implementation("io.data2viz.d2v:timer:0.8.19")
                 implementation("io.data2viz.d2v:viz:0.8.19")
             }
        }
    }
}
