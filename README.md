...
![Build Status](https://img.shields.io/badge/version-0.10.5-blueviolet)
...
kotlin {
    sourceSets {
        commonMain {
             dependencies {
                 implementation("io.data2viz.d2v:d2v-axis:0.10.5")
                 implementation("io.data2viz.d2v:d2v-chord:0.10.5")
                 implementation("io.data2viz.d2v:d2v-color:0.10.5")
                 implementation("io.data2viz.d2v:d2v-contour:0.10.5")
                 implementation("io.data2viz.d2v:d2v-delaunay:0.10.5")
                 implementation("io.data2viz.d2v:d2v-dsv:0.10.5")
                 implementation("io.data2viz.d2v:d2v-ease:0.10.5")
                 implementation("io.data2viz.d2v:d2v-force:0.10.5")
                 implementation("io.data2viz.d2v:d2v-format:0.10.5")
                 implementation("io.data2viz.d2v:d2v-geo:0.10.5")
                 implementation("io.data2viz.d2v:d2v-hexbin:0.10.5")
                 implementation("io.data2viz.d2v:d2v-hierarchy:0.10.5")
                 implementation("io.data2viz.d2v:d2v-quadtree:0.10.5")
                 implementation("io.data2viz.d2v:d2v-random:0.10.5")
                 implementation("io.data2viz.d2v:d2v-scale:0.10.5")
                 implementation("io.data2viz.d2v:d2v-shape:0.10.5")
                 implementation("io.data2viz.d2v:d2v-tile:0.10.5")
                 implementation("io.data2viz.d2v:d2v-time:0.10.5")
                 implementation("io.data2viz.d2v:d2v-timer:0.10.5")
                 implementation("io.data2viz.d2v:d2v-viz:0.10.5")
             }
        }
    }
}
