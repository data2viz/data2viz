...
![Build Status](https://img.shields.io/badge/version-10.0.3-blueviolet)
...
kotlin {
    sourceSets {
        commonMain {
             dependencies {
                 implementation("io.data2viz.d2v:d2v-axis:10.0.3")
                 implementation("io.data2viz.d2v:d2v-chord:10.0.3")
                 implementation("io.data2viz.d2v:d2v-color:10.0.3")
                 implementation("io.data2viz.d2v:d2v-contour:10.0.3")
                 implementation("io.data2viz.d2v:d2v-delaunay:10.0.3")
                 implementation("io.data2viz.d2v:d2v-dsv:10.0.3")
                 implementation("io.data2viz.d2v:d2v-ease:10.0.3")
                 implementation("io.data2viz.d2v:d2v-force:10.0.3")
                 implementation("io.data2viz.d2v:d2v-format:10.0.3")
                 implementation("io.data2viz.d2v:d2v-geo:10.0.3")
                 implementation("io.data2viz.d2v:d2v-hexbin:10.0.3")
                 implementation("io.data2viz.d2v:d2v-hierarchy:10.0.3")
                 implementation("io.data2viz.d2v:d2v-quadtree:10.0.3")
                 implementation("io.data2viz.d2v:d2v-random:10.0.3")
                 implementation("io.data2viz.d2v:d2v-scale:10.0.3")
                 implementation("io.data2viz.d2v:d2v-shape:10.0.3")
                 implementation("io.data2viz.d2v:d2v-tile:10.0.3")
                 implementation("io.data2viz.d2v:d2v-time:10.0.3")
                 implementation("io.data2viz.d2v:d2v-timer:10.0.3")
                 implementation("io.data2viz.d2v:d2v-viz:10.0.3")
             }
        }
    }
}
