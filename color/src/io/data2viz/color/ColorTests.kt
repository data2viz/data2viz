...
class ColorTests: StringSpec(){
    ...
    init {
        ...
        "HSL CONVERSION REFERENCE https://www.w3schools.com/colors/colors_converter.asp : RGB conversion of HSL(0, 0, 0) should be black" {
            val color = HSL(Angle(0.0), 0f, 0f).rgb()
