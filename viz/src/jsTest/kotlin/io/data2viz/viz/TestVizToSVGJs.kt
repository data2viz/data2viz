...
class TestVizToSVGJs : TestBase() {
    ...
    fun testSvgFunctionality() {
        ...
        simpleSvg shouldBe """
            <?xml version="1.0"?>
            <svg width="200" height="200" version="1" xmlns="http://www.w3.org/2000/svg">
    ...
    fun testLinearGradientLogo() {
        viz {
            ...
            <g>
            <rect x="0" y="0" width="400" height="400" style="fill:url('#grad1');stroke-width:1"/>
            <rect x="30" y="30" width="340" height="340" style="fill:rgba(255, 255, 255, 1);stroke-width:1"/>
            <rect x="60" y="60" width="280" height="280" style="fill:url('#grad2');stroke-width:1"/>
            <path style="fill:rgba(255, 255, 255, 1);stroke:rgba(0, 0, 0, 0);stroke-width:1" d="M 200 340 L 340 60 L 360 360 "/>
            <path style="fill:rgba(0, 0, 0, 0);stroke:rgba(255, 255, 255, 1);stroke-width:30" d="M 220 360 L 55 37.5 "/>
            <path style="fill:rgba(0, 0, 0, 0);stroke:rgba(255, 255, 255, 1);stroke-width:30" d="M 340 300 L 215 37.5 "/>
            </g>
            <defs>
            <linearGradient id="grad1" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" style="stop-color:rgba(65, 63, 222, 1)"/>
            <stop offset="25%" style="stop-color:rgba(68, 61, 226, 1)"/>
            <stop offset="50%" style="stop-color:rgba(118, 65, 223, 1)"/>
            <stop offset="75%" style="stop-color:rgba(185, 69, 206, 1)"/>
            <stop offset="100%" style="stop-color:rgba(222, 61, 130, 1)"/>
            </linearGradient>
