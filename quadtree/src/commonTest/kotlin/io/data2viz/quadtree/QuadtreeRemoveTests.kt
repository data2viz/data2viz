...
class QuadtreeRemoveTests : TestBase() {
    ...
    fun `quadtree remove removes a point and returns the quadtree`() {
        val p0 = arrayOf(1, 1)
    ...
    fun `quadtree remove removes the only point in the quadtree`() {
        val p0 = arrayOf(1, 1)
        val quadtree = buildQuadtree() {
            add(p0)
        }
    ...
    fun `quadtree remove removes a first coincident point at the root in the quadtree`() {
        val p0 = arrayOf(1, 1)
        val p1 = arrayOf(1, 1)
        val quadtree = buildQuadtree() {
            add(p0)
    ...
    fun `quadtree remove removes another coincident point at the root in the quadtree`() {
        val p0 = arrayOf(1, 1)
        val p1 = arrayOf(1, 1)
        val quadtree = buildQuadtree() {
            add(p0)
    ...
    fun `quadtree remove removes a non-root point in the quadtree`() {
        val p0 = arrayOf(0, 0)
        val p1 = arrayOf(1, 1)
        val quadtree = buildQuadtree() {
            add(p0)
    ...
    fun `quadtree remove removes another non-root point in the quadtree`() {
        val p0 = arrayOf(0, 0)
        val p1 = arrayOf(1, 1)
        val quadtree = buildQuadtree() {
            add(p0)
    ...
    fun `quadtree remove ignores a point not in the quadtree`() {
        val p0 = arrayOf(0, 0)
        val p1 = arrayOf(1, 1)
    ...
    fun `quadtree remove ignores a coincident point not in the quadtree`() {
        val p0 = arrayOf(0, 0)
        val p1 = arrayOf(0, 0)
        val quadtree0 = buildQuadtree() {
            add(p0)
    ...
    fun `quadtree remove another point in the quadtree`() {
        val quadtree = buildQuadtree() {
