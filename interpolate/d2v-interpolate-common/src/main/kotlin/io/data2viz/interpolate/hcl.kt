...
fun interpolateHclLong(start:Color, end: Color) = interpolateHcl(start, end, long = true)
fun interpolateHcl(start:Color, end:Color) = interpolateHcl(start, end, long = false)
