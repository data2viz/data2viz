...
private val local_noop: (GeoPoint) -> Unit = { _ -> }
 ...
 */
class GeoAreaStream : Stream<GeoPoint>() {
...
//    private var phi0 = 0.rad
    ...
    private var currentPoint: (GeoPoint) -> Unit = local_noop
    ...
    private fun areaPointFirst(point: GeoPoint) {
    ...
    private fun areaPoint(point: GeoPoint) {
        val lon = point.lon
