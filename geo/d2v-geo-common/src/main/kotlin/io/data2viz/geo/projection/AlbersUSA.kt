...
/**
 * TODO: return project Double.NAN when projeciton not possible, for example projecting area outside US
 * This is a U.S.-centric composite projection of three d3.geoConicEqualArea projections: d3.geoAlbers is used
 * for the lower forty-eight states, and separate conic equal-area projections are used for Alaska and Hawaii.
