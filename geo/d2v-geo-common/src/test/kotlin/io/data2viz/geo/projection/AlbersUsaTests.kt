...
class AlbersUsaTests : TestBase() {
    ...
    fun point_invert_returns_the_expected_result() {
        ...
        util.checkProjection(albersUsa, -122.4194, 37.7749, 107.4, 214.1, 0.1) // San Francisco, CA
        util.checkProjection(albersUsa, -74.0059, 40.7128, 794.6, 176.5, 0.1) // New York, NY
