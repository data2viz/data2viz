...
class GraticuleTests : TestBase() {
    ...
    fun graticule_lines_returns_array_of_linestrings_LEGACY() {
        ...
        lines[0].coordinates[0] shouldBe arrayOf(-90.0, -45.0)
        lines[0].coordinates[1] shouldBe arrayOf(-90.0, 45.0)         // meridian
        lines[1].coordinates[0] shouldBe arrayOf(-45.0, -45.0)
        lines[1].coordinates[1] shouldBe arrayOf(-45.0, 45.0)         // meridian
        lines[2].coordinates[0] shouldBe arrayOf(.0, -45.0)
        lines[2].coordinates[1] shouldBe arrayOf(.0, 45.0)            // meridian
        lines[3].coordinates[0] shouldBe arrayOf(45.0, -45.0)
        lines[3].coordinates[1] shouldBe arrayOf(45.0, 45.0)          // meridian
    ...
    fun graticule_graticule_returns_a_multistring_of_all_lines_LEGACY() {
        ...
        lines.coordinates[0][0] shouldBe arrayOf(-90.0, -45.0)
        lines.coordinates[0][1] shouldBe arrayOf(-90.0, 45.0)         // meridian
        lines.coordinates[1][0] shouldBe arrayOf(-45.0, -45.0)
        lines.coordinates[1][1] shouldBe arrayOf(-45.0, 45.0)         // meridian
        lines.coordinates[2][0] shouldBe arrayOf(.0, -45.0)
        lines.coordinates[2][1] shouldBe arrayOf(.0, 45.0)            // meridian
        lines.coordinates[3][0] shouldBe arrayOf(45.0, -45.0)
        lines.coordinates[3][1] shouldBe arrayOf(45.0, 45.0)          // meridian
    }
    ...
    fun graticule_outline_returns_a_polygon_encompassing_the_major_extent_LEGACY() {
        ...
        outline.coordinates[0][0] shouldBe arrayOf(-90.0, -45.0)
        outline.coordinates[0][1] shouldBe arrayOf(-90.0, 45.0)         // meridian
